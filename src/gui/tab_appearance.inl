if (ImGui::BeginTabItem(trc("tabs.appearance"))) {
    ...
    if (ImGui::BeginChild("ColorList", ImVec2(0, 400), true)) {
        ...
        if (ImGui::CollapsingHeader(trc("appearance.text"), ImGuiTreeNodeFlags_DefaultOpen)) {
            ImGui::Indent();
        ...
        if (ImGui::CollapsingHeader(trc("appearance.frame"), ImGuiTreeNodeFlags_DefaultOpen)) {
            ImGui::Indent();
        ...
        if (ImGui::CollapsingHeader(trc("appearance.title_bar"), ImGuiTreeNodeFlags_DefaultOpen)) {
            ImGui::Indent();
        ...
        if (ImGui::CollapsingHeader(trc("appearance.button"), ImGuiTreeNodeFlags_DefaultOpen)) {
            ImGui::Indent();
        ...
        if (ImGui::CollapsingHeader(trc("appearance.header"), ImGuiTreeNodeFlags_DefaultOpen)) {
            ImGui::Indent();
        ...
        if (ImGui::CollapsingHeader(trc("appearance.tab"), ImGuiTreeNodeFlags_DefaultOpen)) {
            ImGui::Indent();
        ...
        if (ImGui::CollapsingHeader(trc("appearance.sliders_scrollbars"), ImGuiTreeNodeFlags_DefaultOpen)) {
            ImGui::Indent();
