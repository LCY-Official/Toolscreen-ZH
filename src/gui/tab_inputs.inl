    ...
    if (ImGui::BeginTabBar("InputsSubTabs")) {
        if (ImGui::BeginTabItem(trc("inputs.mouse"))) {
            ...
            if (g_gameVersion < GameVersion(1, 13, 0)) {
                if (ImGui::Checkbox(trc("label.let_cursor_escape_window"), &g_config.allowCursorEscape)) {
                    g_configIsDirty = true;
                }
                ImGui::SameLine();
            ...
            if (g_config.cursors.enabled) {
                ...
                if (!cursorListInitialized) {
                    ...
                    for (const auto& cursorName : cursorNames) {
                        ...
                        if (cursorName.find("Cross") != std::string::npos) {
                            description = trc("inputs.crosshair_cursor");
                        } else if (cursorName.find("Arrow") != std::string::npos) {
                            description = trc("inputs.arrow_pointer_cursor");
                        } else {
                            description = trc("inputs.custom_cursor");
                        }
                ...
                CursorConfigUI cursors[] = {{"Title Screen", &g_config.cursors.title}, {"Wall", &g_config.cursors.wall}, {"In World", &g_config.cursors.ingame}};
                ...
                if (ImGui::Button((tr("inputs.reset_cursors_to_defaults") + "##cursors").c_str())) {
                    ImGui::OpenPopup(trc("inputs.reset_cursors_to_defaults"));
                }
        ...
        if (ImGui::BeginTabItem(trc("inputs.keyboard"))) {
            ...
            ImGui::SameLine();
            HelpMarker(
                trc("inputs.tooltip.key_repeat_start_delay")
            );
            ...
            ImGui::SameLine();
            HelpMarker(
                trc("inputs.tooltip.key_repeat_delay")
            );
            ...
            ImGui::TextWrapped(
                trc("inputs.tooltip.key_rebinding")
            );
            ImGui::Spacing();
            ...
            ImGui::SameLine();
            HelpMarker(
                trc("inputs.tooltip.enable_key_rebinding")
            );
            ...
            if (g_config.keyRebinds.enabled) {
                ...
                if (ImGui::Button(trc("inputs.open_keyboard_layout"))) {
                    s_keyboardLayoutOpen = true;
                }
                ImGui::SameLine();
                HelpMarker(
                    trc("inputs.tooltip.open_keyboard_layout")
                );
                ...
                if (s_keyboardLayoutOpen) {
                    ...
                    const ImVec2 center =
                        vp ? ImVec2(vp->WorkPos.x + vp->WorkSize.x * 0.5f, vp->WorkPos.y + vp->WorkSize.y * 0.5f)
                ...
                if (s_keyboardLayoutOpen) {
                    ...
                    if (keyboardLayoutWindowVisible) {
                        ...
                        const bool contextPopupOpenNow =
                            ImGui::IsPopupOpen((tr("inputs.rebind_config") + "##layout").c_str()) ||
                            ImGui::IsPopupOpen((tr("inputs.triggers_custom") + "##layout").c_str()) ||
                            ImGui::IsPopupOpen((tr("inputs.custom_unicode") + "##layout").c_str());
                        ...
                        ImGui::BeginChild("##keyboardLayoutChild", ImVec2(0, 0), true, ImGuiWindowFlags_HorizontalScrollbar | ImGuiWindowFlags_AlwaysVerticalScrollbar);
...

                        {
                            ...
                            dl->AddRectFilled(ImVec2(plateMin.x + 5, plateMin.y + 6), ImVec2(plateMax.x + 5, plateMax.y + 6), IM_COL32(0, 0, 0, 130), plateRound);
                            ...
                            const ImVec2 plateMid =
                                ImVec2(plateMax.x, plateMin.y + (plateMax.y - plateMin.y) * plateSplit);
                            ...
                            dl->AddLine(ImVec2(plateMin.x + 6, plateMin.y + 6), ImVec2(plateMax.x - 6, plateMin.y + 6), IM_COL32(255, 255, 255, 25), 1.0f);
                        }

                        static DWORD s_layoutContextVk             = 0;
                        static int   s_layoutContextPreferredIndex = -1;

                        const ImGuiID rebindPopupId        = ImGui::GetID((tr("inputs.rebind_config") + "##layout").c_str());
                        ...
                        auto drawKeyCell = [&](DWORD vk, const char* label,
                            ...
                            auto themeForVk = [&](DWORD v) -> KeyTheme {
                                ...
                                KeyTheme t{IM_COL32(80, 86, 98, 255), IM_COL32(45, 49, 60, 255), IM_COL32(18, 18, 20, 255), IM_COL32(245, 245, 245, 255)};
                                if (isMod) {
                            ...
                            dl->AddRectFilled(ImVec2(pMin.x + shadow, pMin.y + shadow), ImVec2(pMax.x + shadow, pMax.y + shadow), IM_COL32(0, 0, 0, 90), rounding);
                                ...
                                showRebindInfo
                                    ? ((rb->useCustomOutput && rb->customOutputUnicode != 0)
                                           ...
                                           : normalizeMouseButtonLabel(
                                                 VkToString((rb->useCustomOutput && rb->customOutputVK != 0) ? rb->customOutputVK : vk)
                                             ))
                                    : std::string(label);
                        ...
                        for (size_t rowIdx = 0; rowIdx < rows.size(); ++rowIdx) {
                            ...
                            for (size_t colIdx = 0; colIdx < rows[rowIdx].size(); ++colIdx) {
                                ...
                                ImGui::InvisibleButton("##key", ImVec2(keyW, keyH), ImGuiButtonFlags_MouseButtonLeft | ImGuiButtonFlags_MouseButtonRight);
                        ...
                        auto drawTallKey = [&](DWORD vk, const char* label,
                            ...
                            ImGui::InvisibleButton("##tall", ImVec2(w, h), ImGuiButtonFlags_MouseButtonLeft | ImGuiButtonFlags_MouseButtonRight);
                            const ImVec2 pMin = ImGui::GetItemRectMin();
...

                        {
                            ...
                            auto drawMouseSegment = [&](DWORD vk, const char* label,
                                ...
                                const ImVec2 tpos =
                                    ImVec2(segMin.x + (segMax.x - segMin.x - tsz.x) * 0.5f, segMin.y + (segMax.y - segMin.y - tsz.y) * 0.5f);
                        ...
                        if (ImGui::BeginPopup((tr("inputs.rebind_config") + "##layout").c_str())) {
                            ...
                            if (s_layoutUnicodeEditIndex != -1) {
                                MarkRebindBindingActive();
                                ImGui::OpenPopup((tr("inputs.custom_unicode") + "##layout").c_str());
                            }

                            if (ImGui::BeginPopupModal((tr("inputs.custom_unicode") + "##layout").c_str(), NULL, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoTitleBar)) {
                                MarkRebindBindingActive();
                                if (ImGui::IsKeyPressed(ImGuiKey_Escape)) {
                                    s_layoutEscapeRequiresRelease = true;
                                    layoutEscapeConsumedThisFrame = true;
                ...
                if (is_rebind_from_binding) {
                    ImGui::OpenPopup(trc("inputs.bind_from_key"));
                }
                ...
                if (is_vk_binding) {
                    ImGui::OpenPopup(trc("inputs.bind_output_vk"));
                }
                ...
                if (is_text_vk_binding) {
                    ImGui::OpenPopup(trc("inputs.bind_text_override_vk"));
                }

                if (ImGui::BeginPopupModal(trc("inputs.bind_text_override_vk"), NULL, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoTitleBar)) {
                ...
                if (is_scan_binding) {
                    ImGui::OpenPopup(trc("inputs.bind_output_scan"));
                }
